...
import com.yaoting.utf.infrastructure.utils.GapRun;
import com.yaoting.utf.infrastructure.utils.JSONUtils;
...
import static com.yaoting.utf.infrastructure.utils.ValidateUtils.isEmpty;
import static com.yaoting.utf.infrastructure.utils.ValidateUtils.isNotEmpty;
...
public class WalleTaskExecutor implements Executor {
    ...
    private boolean tryStop() {
        ...
        return isEmpty(taskQueue) && isEmpty(futureTasks);
    }
}
